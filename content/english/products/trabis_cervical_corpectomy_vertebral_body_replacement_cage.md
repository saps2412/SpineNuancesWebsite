...
Trabis® is [patented](http://localhost:1313/download/patents) and made in the USA based on Swiss technology.
...
For complete details on the use of Trabis® refer to the valid [Information for Use](http://localhost:1313/download/ifu).

[Peer-reviewed clinical publications on the Trabis® system](http://localhost:1313/download/publications)